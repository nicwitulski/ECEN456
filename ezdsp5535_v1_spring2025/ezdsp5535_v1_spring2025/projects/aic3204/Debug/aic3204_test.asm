...
;* Date/Time created: Mon Jan 29 10:16:55 2024                                 *
;*******************************************************************************
...
;	C:\ti\ccsv6\tools\compiler\c5500_4.4.1\bin\acp55.exe -@C:\\Windows\\system32\\config\\SYSTEM~1\\AppData\\Local\\Temp\\0575213 
	.sect	".text"
...
$C$DW$19	.dwtag  DW_TAG_subprogram, DW_AT_name("AIC3204_rget")
	...
	.dwattr $C$DW$19, DW_AT_TI_begin_file("../aic3204_test.c")
	...
	.dwpsn	file "../aic3204_test.c",line 58,column 1,is_stmt,address _AIC3204_rget
...
$C$DW$25	.dwtag  DW_TAG_variable, DW_AT_name("cmd")
	...
	.dwattr $C$DW$25, DW_AT_location[DW_OP_bregx 0x24 5]
        MOV XAR0, dbl(*SP(#2))
        MOV T0, *SP(#0) ; |58| 
	.dwpsn	file "../aic3204_test.c",line 59,column 12,is_stmt
        MOV #0, *SP(#4) ; |59| 
	.dwpsn	file "../aic3204_test.c",line 62,column 5,is_stmt
        MOV *SP(#0), AR1 ; |62| 
        AND #0x007f, AR1, AC0 ; |62| 
        MOV AC0, *SP(#5) ; |62| 
	.dwpsn	file "../aic3204_test.c",line 63,column 5,is_stmt
        MOV #0, *SP(#6) ; |63| 
	.dwpsn	file "../aic3204_test.c",line 65,column 5,is_stmt
        MOV #24, T0 ; |65| 
        AMAR *SP(#5), XAR0
...
||      MOV #1, T1
        ...
        OR *SP(#4), T0, AR1 ; |66| 
        MOV AR1, *SP(#4) ; |66| 
	.dwpsn	file "../aic3204_test.c",line 68,column 5,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *SP(#5), AR1 ; |68| 
        MOV AR1, *AR3 ; |68| 
...
||      MOV #10, AC0 ; |69| 
	...
	.dwpsn	file "../aic3204_test.c",line 70,column 5,is_stmt
        MOV *SP(#4), T0 ; |70| 
	.dwpsn	file "../aic3204_test.c",line 71,column 1,is_stmt
        AADD #7, SP
	.dwcfi	cfa_offset, 1
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$29, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$19, DW_AT_TI_end_file("../aic3204_test.c")
...
$C$DW$30	.dwtag  DW_TAG_subprogram, DW_AT_name("AIC3204_rset")
	...
	.dwattr $C$DW$30, DW_AT_TI_begin_file("../aic3204_test.c")
	...
	.dwpsn	file "../aic3204_test.c",line 81,column 1,is_stmt,address _AIC3204_rset
...
$C$DW$35	.dwtag  DW_TAG_variable, DW_AT_name("cmd")
	...
	.dwattr $C$DW$35, DW_AT_location[DW_OP_bregx 0x24 2]
        MOV T1, *SP(#1) ; |81| 
        MOV T0, *SP(#0) ; |81| 
	.dwpsn	file "../aic3204_test.c",line 83,column 5,is_stmt
        MOV T0, AR1
	...
	.dwpsn	file "../aic3204_test.c",line 84,column 5,is_stmt
        MOV *SP(#1), AR1 ; |84| 
        MOV AR1, *SP(#3) ; |84| 
	.dwpsn	file "../aic3204_test.c",line 86,column 5,is_stmt
        MOV #300, AC0 ; |86| 
$C$DW$36	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../aic3204_test.c",line 88,column 5,is_stmt
        MOV #24, T0 ; |88| 
...
$C$DW$37	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../aic3204_test.c",line 89,column 1,is_stmt
        AADD #5, SP
	.dwcfi	cfa_offset, 1
$C$DW$38	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$38, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$30, DW_AT_TI_end_file("../aic3204_test.c")
...
$C$DW$39	.dwtag  DW_TAG_subprogram, DW_AT_name("aic3204_test")
	...
	.dwattr $C$DW$39, DW_AT_TI_begin_file("../aic3204_test.c")
	...
	.dwpsn	file "../aic3204_test.c",line 98,column 1,is_stmt,address _aic3204_test
...
_aic3204_test:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-3, SP
	.dwcfi	cfa_offset, 4
	.dwpsn	file "../aic3204_test.c",line 100,column 5,is_stmt
$C$DW$40	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../aic3204_test.c",line 103,column 5,is_stmt
...
$C$DW$42	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$42, DW_AT_TI_call
        ...
        BCC $C$L1,T0 == #0 ; |104| 
                                        ; branchcc occurs ; |104| 
	.dwpsn	file "../aic3204_test.c",line 105,column 9,is_stmt
        MOV #1, T0
        B $C$L3   ; |105| 
                                        ; branch occurs ; |105| 
$C$L1:    
	.dwpsn	file "../aic3204_test.c",line 107,column 5,is_stmt
        MOV #100, AC0 ; |107| 
...
$C$DW$45	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$45, DW_AT_TI_call
        ...
        BCC $C$L2,T0 == #0 ; |109| 
                                        ; branchcc occurs ; |109| 
	.dwpsn	file "../aic3204_test.c",line 110,column 9,is_stmt
        MOV #3, T0
        B $C$L3   ; |110| 
                                        ; branch occurs ; |110| 
$C$L2:    
	.dwpsn	file "../aic3204_test.c",line 112,column 5,is_stmt
        MOV #0, T0
$C$L3:    
	.dwpsn	file "../aic3204_test.c",line 113,column 1,is_stmt
        AADD #3, SP
	.dwcfi	cfa_offset, 1
$C$DW$46	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$46, DW_AT_TI_return
        RET
                                        ; return occurs
	.dwattr $C$DW$39, DW_AT_TI_end_file("../aic3204_test.c")
