...
aic3204.obj: ../aic3204.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"C:/ti/ccsv6/tools/compiler/c5500_4.4.1/bin/cl55" -v5515 -g -O2 --define=c5535 --include_path="C:/ti/ccsv6/tools/compiler/c5500_4.4.1/include" --include_path="C:/git/ECEN456/ezdsp5535_v1_spring2025/ezdsp5535_v1_spring2025/c55xx_csl/inc" --include_path="C:/git/ECEN456/ezdsp5535_v1_spring2025/ezdsp5535_v1_spring2025/include" --diag_warning=225 --ptrdiff_size=16 --memory_model=large -k --preproc_with_compile --preproc_dependency="aic3204.pp" $(GEN_OPTS__FLAG) "$<"
...
myfir.obj: ../myfir.c $(GEN_OPTS) $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C5500 Compiler'
	"C:/ti/ccsv6/tools/compiler/c5500_4.4.1/bin/cl55" -v5515 -g -O2 --define=c5535 --include_path="C:/ti/ccsv6/tools/compiler/c5500_4.4.1/include" --include_path="C:/git/ECEN456/ezdsp5535_v1_spring2025/ezdsp5535_v1_spring2025/c55xx_csl/inc" --include_path="C:/git/ECEN456/ezdsp5535_v1_spring2025/ezdsp5535_v1_spring2025/include" --diag_warning=225 --ptrdiff_size=16 --memory_model=large -k --preproc_with_compile --preproc_dependency="myfir.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
